  ...
  return (
      <div name="About" className='w-full h-screen bg-white text-black'>
        <div className=' p-4 mx-auto flex flex-col justify-center w-full max-w-screen-lg  h-full'>
            ...
            <p className='hover:animate-pulse font-medium'>ash Saxena and I am currently pursuing my BTech from JSS Academy of Technical Education in the field of Information Technology.
